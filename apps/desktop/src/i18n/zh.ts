...
export const zh = defineLocale({
  ...
  starmap: {
    ...
    resetToMine: '返回我的图谱',
    sessionsTitle: '知识来源',
    sessionsLoading: '正在查找会话…',
    sessionsEmpty: '在此配置文件的历史记录中未找到匹配的会话。',
    sessionsProviderOnly: '此条目来自记忆提供方自身的历史（如导入的对话），没有对应的 Hermes 会话。请使用“查看源数据”阅读原文。',
    sessionsSearchNote: '此节点没有记录来源——以下是按内容搜索匹配到的会话。',
    openSession: '打开会话',
    viewSource: '查看源数据',
    sourceTitle: '源数据',
    sourceLoading: '正在加载源数据…',
    sourceEmpty: '源数据不可用——记忆后端无法访问或已不再保存该会话。',
    backToSessions: '返回',
    provenanceMenu: '知识来源…',
    providerReadOnly: provider => `只读 — 由 ${provider} 记忆提供方管理`,
    recreate: '重建为 Hermes 会话',
    recreating: '正在重建…',
    recreateFailed: '无法重建该对话',
    searchTitle: '搜索记忆与技能',
    searchPlaceholder: '搜索…',
    searchRecent: '最近搜索',
    searchSaved: '已保存',
    searchSave: '保存此搜索',
    searchDeleteSaved: '删除已保存的搜索',
    searchFiltersOnly: '（仅筛选条件）',
    searchKind: '类型',
    searchKindAll: '全部类型',
    searchKindSkills: '技能',
    searchSource: '来源',
    searchSourceAll: '全部来源',
    searchSourceHermes: 'Hermes',
    searchSourceImported: source => `导入：${source}`,
    searchFrom: '起始日期',
    searchTo: '结束日期',
    searchCount: n => `${n} 条结果`,
    searchEmpty: '没有匹配的结果。',
    filterTitle: '筛选',
    filterShowing: (shown, total) => `显示 ${shown} / ${total}`,
    filterClear: '清除',
    dateModeLabel: '日期筛选',
    dateModeRange: '自定义范围',
    dateModeYear: '年份',
    dateModeYearMonth: '年 / 月',
    dateYearAny: '任意年份',
    dateMonthLabel: '月份',
    dateMonthAny: '任意月份',
    conclusion: '结论',
    conclusions: '结论',
    conclusionStartConversation: '就此开始一段对话…',
    conclusionSeedPrompt: text => `我想聊聊你对我得出的一个结论：\n\n> ${text}\n\n`,
